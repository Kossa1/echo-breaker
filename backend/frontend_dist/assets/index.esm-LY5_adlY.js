import{r as A,_ as S,C,a as R,E as J,o as Ee,F as X,g as ke,b,d as Re,i as Q,c as Z,e as ee,v as te,L as Pe,f as U}from"./index-BrwFY0_i.js";const ne="@firebase/installations",L="0.6.9";/**
 * @license
 ...
 */const ie=1e4,ae=`w:${L}`,re="FIS_v2",_e="https://firebaseinstallations.googleapis.com/v1",Oe=3600*1e3,De="installations",Fe="Installations";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Gt(){if(ee())try{await te()}catch(e){return u.warn(d.create("indexeddb-unavailable",{errorInfo:e?.toString()}).message),!1}else return u.warn(d.create("indexeddb-unavailable",{errorInfo:"IndexedDB is not available in this environment."}).message),!1;return!0}async function zt(e,t,n,i,a,r,s){var o;const c=$t(e);c.then(h=>{n[h.measurementId]=h.appId,e.options.measurementId&&h.measurementId!==e.options.measurementId&&u.warn(`The measurement ID in the local Firebase config (${e.options.measurementId}) does not match the measurement ID fetched from the server (${h.measurementId}). To ensure analytics events are always sent to the correct Analytics property, update the measurement ID field in the local config or remove it from the local config.`)}).catch(h=>u.error(h)),t.push(c);const l=Gt().then(h=>{if(h)return i.getId()}),[f,m]=await Promise.all([c,l]);Rt(r)||vt(r,f.measurementId),M&&(a("consent","default",M),Ae(void 0)),a("js",new Date);const T=(o=s?.config)!==null&&o!==void 0?o:{};return T[mt]="firebase",T.update=!0,m!=null&&(T[ht]=m),a("config",f.measurementId,T),$&&(a("set",$),Se(void 0)),f.measurementId}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
